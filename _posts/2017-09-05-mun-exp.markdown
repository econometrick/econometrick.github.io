...
![equation](<a href="https://www.codecogs.com/eqnedit.php?latex=y_{i}&space;=&space;\beta_{0}&space;&plus;&space;\beta_{1}&space;x_{i}" target="_blank"><img src="https://latex.codecogs.com/gif.latex?y_{i}&space;=&space;\beta_{0}&space;&plus;&space;\beta_{1}&space;x_{i}" title="y_{i} = \beta_{0} + \beta_{1} x_{i}" /></a>)  
