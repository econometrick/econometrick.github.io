...
<div class="image">
  <img src="/images/r-project-logo.jpg" alt="" />
  <h2>Fazer o download da programação R [aqui](https://github.com/econometrick/econometrick.github.io/blob/master/R/scimagojr_httr.R).   </h2>
</div>
